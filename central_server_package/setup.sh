...
print_warn "1. Copy the template file to the app directory:"
print_warn "   sudo cp ./create_admin_user.php.template ./app/create_admin_user.php"
print_warn "2. (Optional but Recommended) Edit the file to set a strong, temporary password:"
print_warn "   sudo nano ./app/create_admin_user.php"
print_warn "3. Access the script in your browser to create the user:"
print_warn "   - Production: https://<your_domain>/create_admin_user.php"
print_warn "   - Development: http://<ip>:8080/create_admin_user.php"
print_warn "4. CRITICAL: Delete the script immediately after use:"
print_warn "   sudo rm ./app/create_admin_user.php"
print_info "--------------------------------------------------------------------"